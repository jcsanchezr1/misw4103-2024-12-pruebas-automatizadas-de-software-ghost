...
const titleCreacionPost= faker.lorem.word();
const titleCreacionPage= faker.lorem.word();
const nameEdited= faker.lorem.word();
const titleEdited= faker.lorem.word();
const titleDeleted= faker.lorem.word();
