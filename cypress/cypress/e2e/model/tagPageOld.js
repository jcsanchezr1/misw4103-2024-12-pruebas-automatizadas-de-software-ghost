...
class TagPageOld {
    constructor() {
      this.elements = {
        tagsPage:
          "#ember24 > section > div.gh-nav-top > ul.gh-nav-list.gh-nav-manage > li:nth-child(4) > a",
        newTag:
          "#ember3 > div > main > section > header > section > a",
        name: "#tag-name",
        save: "body > div.gh-app.ember-view > div > main > section > form > header > section > button",
        saved: "span > svg",
        getNames: ".gh-tag-list-name",
        slug: "#tag-slug",
        deleteButton: "body > div.gh-app.ember-view > div > main > section > button",
        displayDelete: "body > div.liquid-destination.default-liquid-destination.has-wormholes.ember-view > div:nth-child(2) > div > div > div > div.fullscreen-modal.fullscreen-modal-action.fullscreen-modal-wide > section",
        confirmDelete:
          "body > div.liquid-destination.default-liquid-destination.has-wormholes.ember-view > div:nth-child(2) > div > div > div > div.fullscreen-modal.fullscreen-modal-action.fullscreen-modal-wide > section > div.modal-footer > button.gh-btn.gh-btn-red.gh-btn-icon.ember-view",
