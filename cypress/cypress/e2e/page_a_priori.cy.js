...
import pagesApriori from "./prioriFiles/pages.json";
...
describe("Funcionalidad de Page", (z) => {
    ...
    it('Creación exitosa de un page, visualización del page creado en la sección de Pages', () => {
        ...
        page_name = pagesApriori[10].page_name;;
        page_description = pagesApriori[10].page_description;
        new_page_name = pagesApriori[10].new_page_name;
        new_page_description = pagesApriori[10].new_page_description;
    ...
    it('Creación exitosa de un page, desde editor', () => {
        parentFolder = Cypress.mocha.getRunner().suite.ctx._runnable.parent.title + '/' + Cypress.mocha.getRunner().suite.ctx._runnable.title + '/';
        page_name = pagesApriori[11].page_name;;
        page_description = pagesApriori[11].page_description;
        new_page_name = pagesApriori[11].new_page_name;
        new_page_description = pagesApriori[11].new_page_description;
    ...
    it('Modificación exitosa de un page', () => {
        parentFolder = Cypress.mocha.getRunner().suite.ctx._runnable.parent.title + '/' + Cypress.mocha.getRunner().suite.ctx._runnable.title + '/';
        page_name = pagesApriori[12].page_name;;
        page_description = pagesApriori[12].page_description;
        new_page_name = pagesApriori[12].new_page_name;
        new_page_description = pagesApriori[12].new_page_description;
    ...
    it('Eliminar de manera exitosa una page', () => {
        parentFolder = Cypress.mocha.getRunner().suite.ctx._runnable.parent.title + '/' + Cypress.mocha.getRunner().suite.ctx._runnable.title + '/';
        page_name = pagesApriori[13].page_name;;
        page_description = pagesApriori[13].page_description;
        new_page_name = pagesApriori[13].new_page_name;
        new_page_description = pagesApriori[13].new_page_description;
